...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2019 at 01:04 AM
...
(2, 'Avió airplane ride', 'Avió-airplane-ride', 'Young and old will enjoy taking off in the Avió plane - the Park’s most stand-out attraction...', 'Young and old will enjoy taking off in the Avió plane - the Park’s most stand-out attraction and the first ever flight simulator. It is a replica of the first aircraft to fly from Barcelona to Madrid in 1927. Powered by its own propeller, since 1928 Avió has flown visitors on a flight of sensations that make the imagination soar.', 'You can go on this ride: +120cm,You must be accompanied: 0-120cm'),
