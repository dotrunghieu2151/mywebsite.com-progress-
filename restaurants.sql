...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2019 at 12:51 PM
...
(1, 'Adventurers Club', 'adventurers-club', 'Panorcamic Aream', '10am-6pm', 'Adventurers Club is in Plaça Tibidabo in front of the main entrance, serving a wide range of salads, tapas and sandwiches. It has a terrace, indoor dining room with air conditioning and Wi-Fi. Also, from 10.30 am to 11.30 am, enjoy its breakfast offer for only €3,50: toasted cheese and ham sandwich + coffee or coffee with milk (only available when the amusement park opens). ', '/mywebsite.com/public/image/restaurants/res1.jpg'),
(2, 'Bar Estació', 'bar-estacio', 'Nivell 1', '1pm-5pm', 'You’ll find the Station Bar (Bar Estació) right in the heart of the Park, next to the Tibidabo Express ride. It serves a wide choice of burgers (including vegetarian) roast chicken, salads, chips, chicken nuggets and more. Has indoor dining room with air conditioning and Wi-Fi. ', '/mywebsite.com/public/image/restaurants/res2.jpg'),
...
(8, 'TELEPIZZA-Castle Tavern', 'telepizza-castle-tavern', 'New York', ' from 1 pm to 5 pm. August: from 1 pm until the Park closes.', 'Located next to the Mysterious Castle (Castell Misteriós), the Telepizza café within Taverna del Castell serves a variety of pastas and pizzas to suit all tastes. Also serves options for vegetarians and coeliac sufferers. Come and take advantage of our 2-for-1 offer on pizzas! We have outdoor tables.', '/mywebsite.com/public/image/restaurants/res8.jpg'),
